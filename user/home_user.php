...
<?php
 ...
 <a href ="home_user.php?album_id=<?php echo $row['album_id'] ?>" class="btn btn-outline-primary " style='margin-right:1em'>
     ...
     if(isset($_GET['album_id'])) {
      ...
      <img src="../aset/img/<?php echo $data['image_path']?>" class="card-img-top" title="<?php echo $data['title'] ?>" style="height: 12rem;">
        <div class="card-footer text-center">
          ...
          ?>
          <a href="comment.php?photo_id=<?php echo $photo_id; ?>"><i class="fa-regular fa-comment"></i></a>
            <?php
...
<div class="col-md-3">
      ...
      <img src="../aset/img/<?php echo $data['image_path']?>" class="card-img-top" title="<?php echo $data['title'] ?>" style="height: 12rem;">
        <div class="card-footer text-center">
          ...
          echo mysqli_num_rows($like). ' suka';
          ?>
          <a href="proses_komentar.php?photo_id=<?php echo $photo_id; ?>"><i class="fa-regular fa-comment"></i></a>
          <?php
          $jmlkomen = mysqli_query($koneksi,"SELECT * FROM comments WHERE photo_id='$photo_id'");
           if($jmlkomen){
           $jumlah_komentar = mysqli_num_rows($jmlkomen);
