...
// Query untuk mendapatkan jumlah total foto
$total_photos_query = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM photos");
$total_photos_row = mysqli_fetch_assoc($total_photos_query);
$total_photos = $total_photos_row['total'];

// Menghitung jumlah halaman
$total_pages = ceil($total_photos / $items_per_page);

// Query untuk mendapatkan data foto dengan limit dan offset
